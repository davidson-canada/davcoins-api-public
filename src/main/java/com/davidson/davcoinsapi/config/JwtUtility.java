...
public class JwtUtility implements Serializable {
	...
	// 5 days (in seconds)
	public static final long JWT_TOKEN_VALIDITY = 5 * 24 * 60 * 60L;
    ...
    //for retrieveing any information from token we will need the props.getJwt_secret() key
	...
	//2. Sign the JWT using the HS512 algorithm and props.getJwt_secret() key.
